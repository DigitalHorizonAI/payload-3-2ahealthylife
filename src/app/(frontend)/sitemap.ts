 ...
 * to stumble across a link. Served at 2ahealthylife.com/blog-sitemap.xml, via
 ...
 * 2ahealthylife.com/sitemap.xml. robots.txt points at both.
 */
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // to '', so it emitted 2ahealthylife.com/<slug> — URLs Netlify does not
