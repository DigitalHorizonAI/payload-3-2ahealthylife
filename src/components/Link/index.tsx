...
export const CMSLink: React.FC<CMSLinkType> = (props) => {
  ...
  // and that serializer is hand-rolled, so nothing upstream has sanitized the
  // href yet. Article link nodes now arrive from the content pipeline rather
  // than from an editor typing into /admin, so the href is no longer trusted
  // input. /api/articles is already covered: the stock convertLexicalToHTMLAsync
