...
// writers into posts.content — scripts/import-articles.ts and seed-local.ts
// build Lexical objects and return at the `typeof value !== 'string'` gate
// below, as does the admin panel. The guard belongs at the render sinks, where
// every writer converges. /api/articles already has one: the stock
// convertLexicalToHTMLAsync applies payload/shared's sanitizeUrl. The React
// blog page did not, because RichText/serialize.tsx is hand-rolled — see
